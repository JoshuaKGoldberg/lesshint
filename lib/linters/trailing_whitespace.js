...
module.exports = {
    ...
    suggestFix: function fixTrailingWhitespaceFailure (complaint) {
        var whitespaceParts = complaint.source.split(/\S/);

        return [{
            range: {
                begin: complaint.position - whitespaceParts[whitespaceParts.length - 1].length,
